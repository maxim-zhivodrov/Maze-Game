...
public class BreadthFirstSearch extends ASearchingAlgorithm implements ISearchingAlgorithm, Serializable
{
    ...
    {
        if(domain==null||domain.getStartState()==null||domain.getGoalState()==null)return null;
